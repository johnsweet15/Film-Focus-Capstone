...
class App extends Component {
  ...
  changeToMovie = id => {
    axios
      .get("https://api.themoviedb.org/3/credit/" + id + "?api_key=" + TMDBKey)
      .then(response => {
  ...
  changeToActor = id => {
    axios
      .get("https://api.themoviedb.org/3/person/" + id + "?api_key=" + TMDBKey)
      .then(response => {
              ...
              this.state.showSearch === true ? (
                ...
                <div>
                  ...
                  <Details
                    ...
                    changeToMovie={this.changeToMovie}
                    changeToActor={this.changeToActor}
                    setMovie={this.setMovie}
                    search={this.state.search}
                    showSearch={this.state.showSearch}
